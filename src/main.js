...
var search = require('./song');
var ytdl = require("ytdl-core");
var StreamOptions = {
    filter: 'audioonly', volume: 0.5
};
var MAIN = /** @class */ (function () {
    function MAIN(searchPARAM) {
    ...
    MAIN.prototype.play = function (connection) {
        return __awaiter(this, void 0, void 0, function () {
            var y;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, connection.play(ytdl(this.url), StreamOptions)];
                    case 1:
                        y = _a.sent();
                        return [2 /*return*/, y];
                }
...
function main(params) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, search.getSongSync(params)];
                case 1:
                    a = _a.sent();
                    return [2 /*return*/, new MAIN(a)];
            }
        });
    });
}
function playlist(playlist) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, search.getPlaylist(playlist)];
                case 1:
                    a = _a.sent();
                    return [2 /*return*/, a];
            }
...
function playlistsongs(playlist) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, search.getPlaylistSongs(playlist)];
                case 1:
                    a = _a.sent();
                    return [2 /*return*/, a];
            }
